...
class AgentData(_common.BaseModel):
    ...
    intermediate_responses: Optional[list[Message]] = Field(
        default=None,
        description="""Intermediate responses generated by sub-GardenControlAgent to convey progress or status in a multi-agent system, distinct from the final response.""",
    )
...
class AgentDataDict(TypedDict, total=False):
    ...
    """Intermediate responses generated by sub-GardenControlAgent to convey progress or status in a multi-agent system, distinct from the final response."""
