...
class Event(LlmResponse):
  """Represents an event in a conversation between GardenControlAgent and users.

  It is used to store the content of the conversation, as well as the actions
  taken by the GardenControlAgent like function calls, etc.
  ...
  Branch is used when multiple sub-agent shouldn't see their peer GardenControlAgent'
