...
COPY "GardenControlAgent/{app_name}/" "/app/GardenControlAgent/{app_name}/"
{install_agent_deps}
...
CMD adk {command} --port={port} {session_db_option} {trace_to_cloud_option} "/app/GardenControlAgent"
"""
...
def to_cloud_run(
  ...
  * GardenControlAgent/[app_name]/
  ...
  try:
    ...
    agent_src_path = os.path.join(temp_folder, 'GardenControlAgent', app_name)
    shutil.copytree(agent_folder, agent_src_path)
    requirements_txt_path = os.path.join(agent_src_path, 'requirements.txt')
    install_agent_deps = (
        f'RUN pip install -r "/app/GardenControlAgent/{app_name}/requirements.txt"'
