...
def cli_web(
  ...
  """Starts a FastAPI server with Web UI for GardenControlAgent.

  AGENTS_DIR: The directory of GardenControlAgent, where each sub-directory is a single
...
# The directory of GardenControlAgent, where each sub-directory is a single agent.
...
def cli_api_server(
  ...
  """Starts a FastAPI server for GardenControlAgent.
