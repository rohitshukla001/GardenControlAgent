...
try:
  ...
  logger.debug(
      ...
      ' Interpreter with GardenControlAgent, please install it. If not, you can ignore this'
      ' warning.'
  )
...
try:
  ...
  logger.debug(
      ...
      ' Executor with GardenControlAgent, please install it. If not, you can ignore this'
      ' warning.'
  )
