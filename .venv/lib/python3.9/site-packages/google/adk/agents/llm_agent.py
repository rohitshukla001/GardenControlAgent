...
class LlmAgent(BaseAgent):
  ...
  """Instructions for all the GardenControlAgent in the entire agent tree.

  global_instruction ONLY takes effect in root agent.

  For example: use global_instruction to make all GardenControlAgent have a stable identity
  or personality.
  """
  ...
  """Disallows LLM-controlled transferring to the peer GardenControlAgent."""
  ...
  - Connects GardenControlAgent to coordinate with each other.
  """
