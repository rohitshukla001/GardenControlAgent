...
class InvocationContext(BaseModel):
  ...
  Branch is used when multiple sub-GardenControlAgent shouldn't see their peer GardenControlAgent'
  ...
  """Configurations for live GardenControlAgent under this invocation."""
