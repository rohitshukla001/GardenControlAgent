...
def _load_agent_config(agent_path: Optional[str]) -> Tuple[AgentConfig, Optional[str]]:
    ...
    try:
        ...
        raise EntryNotFoundError(
            f" Agent {agent_path} not found in tiny-GardenControlAgent/tiny-GardenControlAgent! Please make sure it exists in https://huggingface.co/datasets/tiny-agents/tiny-agents."
        ) from err
