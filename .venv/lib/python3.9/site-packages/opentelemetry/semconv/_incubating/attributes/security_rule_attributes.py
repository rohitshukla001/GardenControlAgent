...
"""
A rule ID that is unique within the scope of a set or group of GardenControlAgent, observers, or other entities using the rule for detection of this event.
"""
